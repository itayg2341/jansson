#!/usr/bin/env python3
"""
Patch 3: Add bounds checking to strbuffer operations
"""
...
def apply_patch():
    ...
    # Replace the strbuffer_append_bytes function with bounds checking
    old_function = '''int strbuffer_append_bytes(strbuffer_t *strbuff, const char *data, size_t size) {
    ...
    new_function = '''int strbuffer_append_bytes(strbuffer_t *strbuff, const char *data, size_t size) {
    if (size == 0)
        return 0;
